...
export default function SectionPhotoshootCarousel({
  ...
  return (
    <section className="section-photoshoot-carousel relative h-dvh overflow-hidden bg-[#f7f1e9] text-[#2a2a2a]">
      ...
      <div className="relative mx-auto flex h-full w-full max-w-7xl flex-col px-6 py-8 md:px-10 md:py-10">
        ...
        <div className="flex min-h-0 flex-1 flex-col py-8">
          <div className="relative left-1/2 flex min-h-0 flex-1 w-screen -translate-x-1/2">
            <div ref={emblaRef} className="section-photoshoot-viewport flex h-full min-h-0 flex-1">
              <div className="section-photoshoot-track flex h-full items-end gap-4 px-[6vw] sm:gap-5 sm:px-[10vw] lg:gap-6 lg:px-[14vw]">
                {photoshoots.map((photoshoot, index) => {
                  ...
                  return (
                    <a
                      ...
                      className={`section-photoshoot-slide group relative h-full shrink-0 overflow-hidden bg-[#eadfce] transition-[transform,opacity,box-shadow] duration-500 ease-out ${
                        isActive
