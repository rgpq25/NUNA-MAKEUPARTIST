...
export const Homepage: GlobalConfig = {
  ...
  admin: {
    description: "Editable homepage content consumed by the Astro frontend.",
  },
  versions: {
    drafts: true,
  },
      ...
      fields: [
        {
          ...
          type: "text",
          required: true,
          defaultValue: "Maquillaje editorial y novias con un enfoque atemporal",
        },
        {
          name: "description",
          type: "textarea",
        ...
        },
        {
          ...
          type: "text",
          required: true,
          defaultValue: "Basada en Madrid · Disponible internacionalmente",
        },
        {
          name: "image",
          type: "relationship",
      ...
      fields: [
        {
          ...
          minRows: 1,
          maxRows: 4,
          validate: (value) => validateNavigationItems(value as unknown[] | null | undefined),
          admin: {
            description:
          ...
          fields: [
            ...
            },
            {
              ...
              admin: {
                condition: (
                  _: unknown,
                  siblingData?: { type?: "contact" | "section" },
                ) => siblingData?.type === "section",
              },
              validate: (
                value: unknown,
                { siblingData }: { siblingData?: { type?: "contact" | "section" } },
              ) => {
